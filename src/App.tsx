...
import { Brush, Circle, Minus, MoveUpRight, Square, Text } from "lucide-react";
  ...
  return (
    <>
      ...
      <nav className="flex justify-between p-2">
        {/* logo */}
        <motion.div
          className="rounded-full bg-gradient-to-br from-gray-200/80 via-gray-500/80 to-blue-300/15 opacity-75 h-14 w-14 shadow-2xl shadow-gray-500/10"
          animate={{ rotate: 360 }}
        ...
        <div className="flex px-2 py-1 bg-gradient-to-b from-gray-400/30 via-gray-500/30 to-blue-300/10 rounded-xl items-center border border-gray-500/50 shadow-2xl shadow-gray-500/10">
          <div className="flex text-white gap-3 hover:bg-gray-300/10 p-3 px-8 rounded-lg transition duration-300 cursor-pointer">
      ...
      <div className="flex flex-col items-center w-screen pt-16">
        ...
        <div className="main-hero-composition flex justify-center items-center gap-56 flex-wrap mt-4">
          ...
          <div className="flex flex-col relative">
            ...
            <div className="flex flex-row justify-between absolute top-0">
              ...
              <div className="flex flex-col items-center absolute top-0 left-0">
                ...
                <div className="w-0.5 h-40 bg-gradient-to-r from-white/0 via-white/35 to-white/0 rounded-full"></div>
              </div>
              ...
              <div className="flex flex-col items-center absolute top-10 left-35">
                ...
                {/* line */}
                <div className="w-0.5 h-24 bg-gradient-to-r from-white/0 via-white/35 to-white/0 rounded-full"></div>
              </div>
            ...
            <div className="flex justify-center gap-10 mt-8 text-white">
              ...
              <div className="flex flex-col items-center absolute top-70 left-5">
                ...
                <div className="w-0.5 h-32 bg-gradient-to-r from-white/0 via-white/35 to-white/0"></div>
              ...
              <div className="flex flex-col items-center absolute top-70 left-39">
                ...
                <div className="w-0.5 h-20 bg-gradient-to-r from-white/0 via-white/35 to-white/0"></div>
              ...
              <div className="flex flex-col items-center absolute top-70 left-68">
                ...
                <div className="w-0.5 h-28 bg-gradient-to-r from-white/0 via-white/35 to-white/0"></div>
          ...
          <div className="flex flex-col items-center gap-6 justify-center">
            ...
            {/* hero heading */}
            <h1 className="text-4xl font-bold bg-gradient-to-br to-gray-400 via-gray-500 from-gray-300 bg-clip-text text-transparent">
            ...
            {/* Summary */}
            <p className="text-center text-white text-md max-w-xl opacity-80">
            ...
            {/* Tech Boxes */}
            <div className="flex flex-wrap gap-6 justify-center w-[420px]">

              {/* Framework */}
              <div className="px-4 py-3 text-white rounded-xl shadow-2xl bg-gradient-to-br from-gray-400/20 via-gray-600/20 to-blue-300/10 backdrop-blur-lg border border-white/10">
            ...
            <div className="flex gap-4 pt-6">
              <button className="px-5 py-2 bg-gradient-to-br from-gray-400/20 via-gray-600/20 to-blue-300/10 text-white rounded-xl shadow-lg transition hover:scale-105 duration-300">
                View Other Projects
              </button>
              <button className="px-5 py-2 bg-white text-gray-800 font-semibold rounded-xl shadow-lg transition hover:scale-105 duration-300">
                Start Drawing
              </button>
            </div>
          </div>
